...
"Double vie de VÚronique, La (Double Life of Veronique, The) (1991)",
...
"Two Much (1996)",
"Trust (1990)",
"C'est arrivÚ prÞs de chez vous (1992)",
"Firestorm (1998)",
...
"JLG/JLG - autoportrait de dÚcembre (1994)",
"Faust (1994)",
...
if(start === true){
		...
		RandomThing = movies[i].replace(/([\(])\d+([\)])/g,"");
		RandomThing2 = movies[i].replace(/([\(])\d+([\)])/g,"");
...
RandomThing2 = movies[i].replace(/([\(])\d+([\)])/,"");
...
$('#skip').click(function(){
	...
	$("input[type=radio]").change(function(){
		ratings.push(i+1 + "," + movies[i] +"," + "944"+ ","+ ($(this).val()));
		MovieCall();
		i = i+1;
		console.log(ratings);
	});
